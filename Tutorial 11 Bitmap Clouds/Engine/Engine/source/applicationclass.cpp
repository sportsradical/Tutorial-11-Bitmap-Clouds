...
bool ApplicationClass::Initialize(HINSTANCE hinstance, HWND hwnd, int screenWidth, int screenHeight)
{
	...
	result = m_Terrain->Initialize(m_Direct3D->GetDevice(), m_Direct3D->GetDeviceContext(), "../Engine/data/heightmap01.bmp", "../Engine/data/dirt01.tga", "../Engine/data/colorm01.bmp");
	if(!result)
	{
	...
	result = m_SkyPlane->Initialize(m_Direct3D->GetDevice(), m_Direct3D->GetDeviceContext(), "../Engine/data/cloud001.tga", "../Engine/data/cloud002.tga");
	if(!result)
	{
