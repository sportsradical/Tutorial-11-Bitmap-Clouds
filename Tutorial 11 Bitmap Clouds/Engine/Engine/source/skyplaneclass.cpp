...
bool SkyPlaneClass::Initialize(ID3D11Device* device, ID3D11DeviceContext* deviceContext, char* textureFilename1, char* textureFilename2)
{
...
bool SkyPlaneClass::LoadTextures(ID3D11Device* device, ID3D11DeviceContext* deviceContext, char* textureFilename1, char* textureFilename2)
{
	bool result;
